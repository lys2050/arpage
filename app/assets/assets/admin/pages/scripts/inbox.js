var Inbox = function () {
    ...
    var loadInbox = function (el, name) {
        ...
        var title = $('.inbox-navss > li.' + name + ' a').attr('data-title');
        listListing = name;
        ...
        $.ajax({
            ...
            success: function(res) 
            {
                ...
                $('.inbox-navss > li.active').removeClass('active');
                $('.inbox-navss > li.' + name).addClass('active');
        ...
        if ($.support.cors) {
            $.ajax({
                ...
                $('<span class="alert alert-error"/>')
                    .text('Upload server currently unavssailable - ' +
                    new Date())
                    .appendTo('#fileupload');
            });
        }
    ...
    return {
        ...
        init: function () {
            ...
            $('.inbox-navss > li.inbox > a').click(function () {
                loadInbox($(this), 'inbox');
            });

            // handle sent listing
            $('.inbox-navss > li.sent > a').click(function () {
                loadInbox($(this), 'sent');
            });

            // handle draft listing
            $('.inbox-navss > li.draft > a').click(function () {
                loadInbox($(this), 'draft');
            });

            // handle trash listing
            $('.inbox-navss > li.trash > a').click(function () {
