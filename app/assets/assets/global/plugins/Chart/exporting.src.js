...
//highcharts export multiple charts to pdf

// JSLint options:
/*global Highcharts, HighchartsAdapter, document, window, Math, setTimeout */
define('exporting', ['jquery'], function (require, exports, module) {
    var $ = require('jquery');
    (function (Highcharts) { // encapsulate
        ...
        extend(defaultOptions.lang, {
            printChart: '打印报表',
            downloadPNG: '下载为PNG图片格式',
            downloadJPEG: '下载为JPEG图片格式',
            downloadPDF: '下载为PDF文档格式',
            downloadSVG: '下载为SVG图片格式',
            contextButtonTitle: '打印 下载'
        });
        ...
        defaultOptions.exporting = {
            ...
            //  url: 'http://h.export.com.cn/HighchartsExport.aspx',
            url: 'http://t.index.autohome.com.cn/HighchartsExport.aspx',

            //	url: 'http://localhost:8461/HighchartsExport.aspx',
            //width: undefined,
            //scale: 2
            buttons: {
                contextButton: {
